  ...
  return Promise.resolve().
    then(() => {
      ...
      const message = [
        ...
        '--al-suppressTbj: Suppress the "Terminate batch job (Y/N)?" confirmation on Windows. (Still experimental.)',
...
function helpForCategory(catName, catSpec, joiner) {
  ...
  return [
    ...
    Object.keys(catSpec).
      ...
      map(name => [name, utils.getSpec(catSpec, name)]).
