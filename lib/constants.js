...
const ALIASES = {
  ...
  node: {
    ...
    // RUN / TEST
    nr: 'npm run $* --al-suppressTbj',
    ns: 'npm start $* --al-suppressTbj',
    nt: 'npm test $* --al-suppressTbj',
    yr: 'yarn run $* --al-suppressTbj',
    ys: 'yarn start $* --al-suppressTbj',
    yt: 'yarn test $* --al-suppressTbj',
