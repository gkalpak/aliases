...
const DEF_CODE = (cmd, cfg = {}) => utils.stripIndentation(`
  ...
  if (require.main === module) {
    ...
    runner.run(cmd, args, Object.assign(${JSON.stringify(cfg)}, config));
  }
`);
...
const ALIASES = {
  ...
  git: {
    ...
    gcmfc: 'git commit --all --fixup ${0:`__g-pick-commit --al-returnOutput=1`} $*',
    gcmifc: 'git commit --fixup ${0:`__g-pick-commit --al-returnOutput=1`} $*',
