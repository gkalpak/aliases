...
const ALIASES = {
  ...
  git: {
    ...
    // CHECKOUT
    gco: 'git checkout ${*:`__gbp --al-returnOutput=1`}',
    ...
    gbd: 'git branch --delete --force ${*:`__gbp --al-returnOutput=1`}',
    ...
    // REBASE
    grb: 'git rebase ${*:`__gbp --al-returnOutput=1`}',
    ...
    gcp: 'echo "  Cherry-picking SHA: $1  " && ' +
         'echo "----------------------------------------------------------------" && ' +
         'echo "                                                                " && ' +
         'git checkout ${2:`__gbp --al-returnOutput=1`} && ' +
         'git pull --rebase origin ${2:`__gbp --al-returnOutput=1`} && ' +
         'git cherry-pick $1 && ' +
         'ngm-diff-wh origin/${2:`__gbp --al-returnOutput=1`} && ' +
         '(git log --decorate || true) && ' +
         'echo "                                                                " && ' +
         'echo "----------------------------------------------------------------" && ' +
         'echo "     >>>  (Don\'t forget to manually push the changes.)  <<<     "',
    gcpl: 'gcp ${0:`git rev-parse HEAD`} ${1:`__gbp --al-returnOutput=1`}',
